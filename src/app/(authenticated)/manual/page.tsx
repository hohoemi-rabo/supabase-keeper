            ...
            <div>
              ...
              <table className="w-full border border-gray-200 rounded text-sm">
                ...
                <tbody>
                  ...
                  <tr>
                    <td className="px-3 py-2 border-b border-gray-100 font-medium">Keep-alive URL</td>
                    <td className="px-3 py-2 border-b border-gray-100 font-mono text-xs">https://my-app.vercel.app/api/keepalive</td>
                    <td className="px-3 py-2 border-b border-gray-100 text-gray-600">Step 1で作成したエンドポイントのURL</td>
                  </tr>
                  <tr>
                    <td className="px-3 py-2 font-medium">Token</td>
          ...
          <tbody>
            <tr>
              <td className="py-2 pr-4 w-24">
                <span className="inline-flex px-1.5 py-0.5 rounded text-xs font-bold bg-emerald-100 text-emerald-800 border border-emerald-300">OK</span>
              </td>
              <td className="py-2 text-gray-700">正常に稼働中。直近のpingが成功しています。</td>
            </tr>
            <tr>
              <td className="py-2 pr-4">
                <span className="inline-flex px-1.5 py-0.5 rounded text-xs font-bold bg-amber-100 text-amber-900 border border-amber-300">WARN</span>
              </td>
              <td className="py-2 text-gray-700">連続2回以上失敗。URLやTokenを確認してください。</td>
            </tr>
            <tr>
              <td className="py-2 pr-4">
                <span className="inline-flex px-1.5 py-0.5 rounded text-xs font-bold bg-red-100 text-red-900 border border-red-300">DOWN</span>
              </td>
              <td className="py-2 text-gray-700">連続5回以上失敗、または3日以上成功なし。対象プロジェクトの状態を確認してください。</td>
            </tr>
          </tbody>
        </table>
      </div>
